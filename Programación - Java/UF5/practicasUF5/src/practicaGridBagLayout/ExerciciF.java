...
public class ExerciciF extends JFrame implements ActionListener{
	public ExerciciF() {
		//	<--- CANCELAR cierra el programa --->
		// TIENE JSCROLL PANE PARA EL TEXT AREA
		...
		JScrollPane scrollpane = new JScrollPane(fieldComent);
		constraints.gridx=0;
		constraints.gridy=2;
		constraints.gridwidth=2;
		...
		constraints.insets=new Insets(15,15,25,15);
		constraints.gridwidth=1;
		constraints.gridheight=1;
